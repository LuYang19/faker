...
person_en = R6Class(
  ...
  private = list(
    ...
    suffixes_female = c("MD", "DDS", "PhD", "DVM"),
    suffixes_male = c("Jr.", "Sr.", "I", "II", "III",
                      "IV", "V", "MD", "DDS", "PhD", "DVM"),
...
address_en = R6Class(
  ...
  private = list(
    ...
    last_names = (person_en$new())$.__enclos_env__$private$last_names,
    last_name = (person_en$new())$last_name,
    ...
    countries = c(
      ...
      'Colombia', 'Comoros', 'Congo', 'Congo', 'Cook Islands',
      'Costa Rica', "Cote d\'Ivoire", 'Croatia', 'Cuba',
      'Cyprus', 'Czech Republic',
      'Denmark', 'Djibouti', 'Dominica', 'Dominican Republic',
      'Ecuador', 'Egypt', 'El Salvador', 'Equatorial Guinea',
      'Eritrea', 'Estonia', 'Ethiopia',
      'Faroe Islands', 'Falkland Islands (Malvinas)', 'Fiji',
      ...
      'Kazakhstan', 'Kenya', 'Kiribati', 'Korea', 'Korea',
      ...
      'Svalbard & Jan Mayen Islands', 'Swaziland', 'Sweden', 'Switzerland',
